...
try:
    ...
    try:
        cursor.execute("ALTER TABLE Properties ADD COLUMN rating DECIMAL(3,2) DEFAULT 0.0")
        cursor.execute("ALTER TABLE Properties ADD COLUMN review_count INT DEFAULT 0")
        cursor.execute("ALTER TABLE Properties ADD COLUMN latitude DECIMAL(9,6) DEFAULT 0.0")
        cursor.execute("ALTER TABLE Properties ADD COLUMN longitude DECIMAL(9,6) DEFAULT 0.0")
