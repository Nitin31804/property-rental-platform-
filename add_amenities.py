...
types = ['Hotel', 'Villa', 'Cabin', 'Loft', 'Apartment', 'Mansion', 'Cottage', 'Studio', 'Chalet', 'Resort', 'Guesthouse']
amenities_pool = ['Pool', 'WiFi', 'Pet Friendly', 'Free Parking', 'Air Conditioning', 'Kitchen', 'Gym', 'Hot Tub', 'Breakfast Included', 'Balcony', 'Ocean View']
...
try:
    ...
    try:
        cursor.execute("ALTER TABLE Properties ADD COLUMN property_type VARCHAR(50) DEFAULT 'Apartment'")
        cursor.execute("ALTER TABLE Properties ADD COLUMN amenities VARCHAR(500) DEFAULT ''")
