...
countries_data = {
    ...
    "United States": {
        ...
        "brands": ["Ritz-Carlton", "Four Seasons", "Hilton", "Marriott", "Waldorf Astoria"],
...
amenities_list = ["Pool", "Free WiFi", "Pet Friendly", "Kitchen", "Breakfast Included", "Ocean View", "Gym", "Spa", "Parking"]
...
for country, data in countries_data.items():
    for i in range(25): # 25 per country
        ...
        val = (host_id, title, desc, city, country, price, cover_img, prop_type, prop_amenities)
...
generic_countries = ["Canada", "Germany", "Netherlands", "Greece", "Mexico", "South Africa", "Thailand", "Switzerland", "New Zealand", "Egypt"]
...
print(f"Successfully generated {props_inserted} realistic properties across 20 top countries!")
